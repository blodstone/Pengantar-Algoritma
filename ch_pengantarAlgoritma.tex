...
\begin{enumerate}
	...
	\begin{figure}
	\centering
	\includegraphics[scale=0.3]{fig/1/Gambar2.png}	
	\end{figure}
	%%%%%%
\newpage
	...
	\begin{figure}
	\centering
	\includegraphics[scale=0.4]{fig/1/Gambar3.png}	
	\end{figure}
	%%%%%%
	\item Anda diminta melakukan output pejabat dengan kekayaan tertinggi !
	\begin{figure}
	\centering
	\includegraphics[scale=0.4]{fig/1/Gambar4.png}	
	\end{figure}	
\end{enumerate}
...
\newpage	
\subsection{Operator}
Pada algoritma, operator berfungsi untuk menghubungkan satu atau lebih variabel sehingga menghasilkan nilai baru. Operator memiliki prioritas eksekusi. 

	\begin{figure}[h]
	\centering
	\includegraphics[scale=0.35]{fig/1/Gambar21.png}	
	\end{figure}	
